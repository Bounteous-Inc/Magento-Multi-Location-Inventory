...
/**
 * Class Demac_MultiLocationInventory_Model_System_Config_Backend_Image
 */
class Demac_MultiLocationInventory_Model_System_Config_Backend_Image extends Mage_Adminhtml_Model_System_Config_Backend_Image
{
    /**
     * The tail part of directory path for uploading
     */
    const UPLOAD_DIR = 'multilocationinventory/images';
